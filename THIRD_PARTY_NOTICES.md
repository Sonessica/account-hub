...
- Project: [bravohenry/openbento](https://github.com/bravohenry/openbento)
- Upstream revision checked: `0f910b96b51925839fbb7b16503edec8b40996c1`
- Copyright: OpenBento Community contributors; the upstream Git history
  identifies Zihan Huang as the original author.
- License: MIT, as declared by the upstream `package.json`.
...
## Uiverse saving indicator

- Source: [empty-wombat-2 by ashif_6672](https://uiverse.io/ashif_6672/empty-wombat-2)
- Location: `src/bento/editor/SavingLoader.module.css`
- Copyright (c) 2026 ashif_6672 (Ashif)
- License: MIT

The source file retains the applicable copyright notice and complete MIT
permission and warranty text.
